...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_custom_scss__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_custom_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__css_custom_scss__);
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(document).ready(function () {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".home").show();
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".navbar-toggle").click(() => {
    if (show_navbar == true) {
        show_navbar = false;
        __WEBPACK_IMPORTED_MODULE_2_jquery___default()("#navbar").addClass("hidden");
    } else {
        show_navbar = true;
        //$(".hidden").show();
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".home-button").click(() => {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".home-button").addClass("active");
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".about-button").removeClass("active");

    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".home").show();
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".about").hide();
});

__WEBPACK_IMPORTED_MODULE_2_jquery___default()(".about-button").click(() => {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".home-button").removeClass("active");
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".about-button").addClass("active");

    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".home").hide();
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".about").show();
});
